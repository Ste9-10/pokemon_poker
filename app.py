...
app = Flask(__name__)
app.secret_key = "supersecretkey_pokemonpoker_12345"

# Configurazione upload avatar e avatar predefiniti
AVATAR_UPLOAD_FOLDER = 'static/uploads/avatars'
DEFAULT_AVATARS_FOLDER = 'static/images/avatars'
...
def kick_player(room_id, player_name):
    ...
    if player_name == user:
        return jsonify({'success': False, 'error': 'Non puoi espellere te stesso'})
